...
public class ChangeUpdateActivity extends AppCompatActivity {
   ...
   //     final Spinner demotion = findViewById(R.id.add_emotion);
    ...
    //    ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
     ...
     //   demotion.setAdapter(adapter);


        Intent intent = getIntent();
        String title = intent.getExtras().getString("title");
        String getDate = intent.getExtras().getString("date");
        String getContent = intent.getExtras().getString("content");
        ...
        islandRef.getBytes(ONE_MEGABYTE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                dpicture.setImageBitmap(bitmap);
        ...
        add_date.setText(getDate);
        add_content.setText(getContent);
    ...
    private void localUpoad() {
        ...
        dpicture.setDrawingCacheEnabled(true);
        dpicture.buildDrawingCache();
        Bitmap bitmap = ((BitmapDrawable) dpicture.getDrawable()).getBitmap();
    ...
    //    String emotion = ((Spinner)findViewById(R.id.add_emotion)).getSelectedItem().toString();
        String content = ((EditText)findViewById(R.id.add_content)).getText().toString();
        ...
        final String getTitle = intent.getExtras().getString("title");
        ...
        if(title.length()>0 && date.length() > 0 && content.length() > 0) {
            ...
            DiaryInfo diaryInfo = new DiaryInfo(title, date, content, pictureLink, db_date, getTime, pre_emotion, birthday);
    ...
    private void deleteDiary(){
        ...
        db.collection("diarys/"+user.getUid()+"/diarys").document(title)
                .delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
      ...
      /*  StorageReference storageRef = storage.getReference();
        StorageReference desertRef = storageRef.child("diarys/"+user.getUid() + "/" + title);
